...
#define STRING_CONFIG_H_AUTHOR "Enrique Walter Philippeaux" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HellCNC"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "ad6da323-885e-4cab-a7b0-0f43054ab8fd"
...
#define Z_PROBE_FEEDRATE_FAST (90)
...
#define X_MIN_POS -11
#define Y_MIN_POS -4
#define Z_MIN_POS -2 // allow for negative Z values
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT PCB_ORIGIN_X  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT PCB_ORIGIN_Y  // (mm) Y point for Z homing
#endif
